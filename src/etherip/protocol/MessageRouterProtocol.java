...
public class MessageRouterProtocol extends ProtocolAdapter {
    ...
    public String decodeExtendedStatus(final int ext_status) {
        switch (ext_status) {
            ...
            case 0x0204:
                return "Unconnected send timed out, no module in slot?";
            case 0x0312:
                return "link not found, no module in slot?";
            case 0x0318:
                return "link to self invalid";
            case 0x2105:
                return "Access beyond end of object, wrong array index";
            case 0x2107:
                return "CIP type does not match object type";
            case 0x2104:
                return "Beginning offset beyond end of template";
        }
        return "<unknown>";
    }
}
